...
namespace Ventas.Application.Service
{
    public class DetalleVentaService : IDetalleVentaService
    {
        ...
        public DetalleVentaService(IVentaRepository ventaRepository,
        ...
        public ServiceResult Save(DetalleVentaAddDto model)
        {
            ServiceResult result = DetalleValidationHelper.ValidateVentaData(model);
        ...
        public ServiceResult Update(DetalleVentaUpdateDto model)
        {
            ...
            try
            {
                var DetalleVenta = model.ConvertDtoToUpdateEntity();
